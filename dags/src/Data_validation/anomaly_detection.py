...
from src.Data_validation.data_schema_statistics_generation import (infer_schema, save_schema, validate_data_schema, read_data, prepare_train_data)
...
def validate_data(input_file_path, output_file_path):
    ...
    custom_log(f"Data processing complete and saved to {output_file_path}")
...
def anomaly_detection():
    ...
    try:
        # Process the data
        validate_data(INPUT_FILE_PATH, OUTPUT_PICKLE_PATH) 
