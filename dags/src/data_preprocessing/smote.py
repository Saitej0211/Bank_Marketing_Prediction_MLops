...
def smote_analysis(input_file_path):
    try:
        custom_log("Starting SMOTE analysis")
        ...
        custom_log(f"Target variable distribution before SMOTE:\n{y.value_counts(normalize=True)}")
        ...
        df_test = pd.concat([pd.DataFrame(X_test, columns=X.columns), 
        ...
        with open(train_pkl_path, 'wb') as f:
            pickle.dump({'X_train': X_train_resampled, 'y_train': y_train_resampled}, f)
        ...
        custom_log("SMOTE analysis completed successfully")
...
if __name__ == "__main__":
    ...
    train_path, test_path = smote_analysis()
